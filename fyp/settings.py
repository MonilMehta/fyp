...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-rsssb!zi9tu&ao2qh^7yf$xj70hm3huexyj6jnbtzh=*140snz')
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Document Asset Tracker API',
    'DESCRIPTION': 'A stealth document tracking system disguised as a SaaS asset server',
    'VERSION': '1.0.0',
